...
\def\Rcup{\Diagram{\draw[mid arrow] (1,1) .. controls +(down:0.5) and +(down:0.5) .. (2,1);}}
\def\Lcup{\Diagram{\draw[mid arrow] (2,1) .. controls +(down:0.5) and +(down:0.5) .. (1,1);}}
...
\def\Fcross{\Diagram{\draw[->] (0,0) -- (1,1);\draw[->] (1,0) -- (0,1);}}
