...
\def\cup{\Diagram{\draw (1,1) .. controls +(down:0.5) and +(down:0.5) .. (2,1);}}
\def\cap{\Diagram{\draw (1,0) .. controls +(up:0.5) and +(up:0.5) .. (2,0);}}
\def\id{\Diagram{\draw (1,0) -- (1,1);}}

\def\capR{\Diagram{\draw[mid arrow] (1,0) .. controls +(up:0.5) and +(up:0.5) .. (2,0);}}
\def\idF{\Diagram{\draw[mid arrow] (1,0) -- (1,1);}}
\def\idB{\Diagram{\draw[mid arrow] (1,1) -- (1,0);}}
